...
from src.predict import CIFAR10_CLASSES, build_predict_transform, load_data_stats, predict_proba
...
def load_class_names():
    """Prefer the class list `train.py` persists alongside the checkpoint;
    fall back to the hardcoded CIFAR10_CLASSES for older experiments that
    predate classes.json."""
...
def load_model(num_classes):
    ...
    model = SimpleCNNConv3(num_classes=num_classes, dropout=dropout)
